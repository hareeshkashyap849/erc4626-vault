...
| D8 | A wallet dApp | **Done, in this repository's `web/`** — connect, deposit, redeem and approve, with the five failure classes handled and tested (`test/wallet.test.mjs`, 33 tests), published at <https://wuzilin-web3.github.io/erc4626-vault/>. **The half that is still open is the manual browser checklist**, not the dApp (P3 below) |
